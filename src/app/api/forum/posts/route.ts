...
export async function POST(req: NextRequest) {
  ...
  const { title, body: postBody, postType, categoryId, tags, isAnonymous, realization, whatChanged, practicingNow } = body;
  ...
  const validTypes = ["question", "reflection", "experience", "teaching", "discussion", "journal", "resource"];
